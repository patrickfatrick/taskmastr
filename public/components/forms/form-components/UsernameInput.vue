<template>
	<div class="error-text">
		...
		<span v-show="$route.path === '/forgot' && forgotAttempt">That username doesn't exist</span>
		<span v-show="$route.path === '/forgot' && forgotEmail">Check your email for instructions on how to reset your password.</span>
	</div>
